        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OEM = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    JobOrderNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Km = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Engineer = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    VehicleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeferredWorks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeferredWorks_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredWork = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobOrderNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Km = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Inspection = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    VehicleId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuedParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssuedParts_JobOrders_JobOrderId",
                        column: x => x.JobOrderId,
                        principalTable: "JobOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IssuedParts_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobOrderWorkItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobOrderWorkItems_JobOrders_JobOrderId",
                        column: x => x.JobOrderId,
                        principalTable: "JobOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeferredWorks_VehicleId",
                table: "DeferredWorks",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuedParts_JobOrderId",
                table: "IssuedParts",
                column: "JobOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_IssuedParts_PartId",
                table: "IssuedParts",
                column: "PartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobOrderWorkItems_JobOrderId",
                table: "JobOrderWorkItems",
                column: "JobOrderId");
