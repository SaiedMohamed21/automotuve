        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierAccountTransactions_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierPayments_SupplierPurchases_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierPurchaseItems_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierPurchaseItems_SupplierPurchases_PurchaseId",
                        column: x => x.PurchaseId,
                        principalTable: "SupplierPurchases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierAccountTransactions_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPurchaseItems_PartId",
                table: "SupplierPurchaseItems",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierPurchaseItems_PurchaseId",
                table: "SupplierPurchaseItems",
                column: "PurchaseId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierPurchases_PurchaseNumber",
