...
function Body() {
  return (
    <div className="content-stretch flex flex-col h-[791px] items-start relative shrink-0 w-[1194px]" data-name="Body">
      <App />
    </div>
  );
}
...
function Sidebar() {
  return (
    <div className="absolute bg-[#060f1e] content-stretch flex flex-col h-[791px] items-start left-0 top-0 w-[224px]" data-name="Sidebar">
      <Container40 />
      <Navigation />
      <Container43 />
    </div>
