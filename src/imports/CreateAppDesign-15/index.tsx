import svgPaths from "./svg-xex9hft341";
...
function Paragraph8() {
  return (
    <div className="content-stretch flex flex-col h-[36px] items-start pt-[4px] relative shrink-0 w-[110.3px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#bb4d00] text-[24px] whitespace-nowrap">4</p>
    </div>
  );
}
...
function HeaderCell() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[36.388px] left-0 top-0 w-[211.913px]" data-name="Header Cell">
...
function HeaderCell1() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[36.388px] left-[211.91px] top-0 w-[193.887px]" data-name="Header Cell">
...
function HeaderCell2() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[36.388px] left-[405.8px] top-0 w-[148.575px]" data-name="Header Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[132.86px] not-italic text-[#6a7282] text-[12px] text-right top-[10px] tracking-[0.6px] uppercase whitespace-nowrap">KM</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[36.388px] left-[554.38px] top-0 w-[182.738px]" data-name="Header Cell">
...
function HeaderCell4() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[36.388px] left-[737.11px] top-0 w-[183.688px]" data-name="Header Cell">
...
function TableCell() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-0 top-[36.39px] w-[211.913px]" data-name="Table Cell">
...
function TableCell1() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[211.91px] top-[36.39px] w-[193.887px]" data-name="Table Cell">
...
function TableCell2() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[405.8px] top-[36.39px] w-[148.575px]" data-name="Table Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-[132.77px] text-[#364153] text-[14px] text-right top-[13.19px] whitespace-nowrap">125,430</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[554.38px] top-[36.39px] w-[182.738px]" data-name="Table Cell">
...
function TableCell4() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[737.11px] top-[36.39px] w-[183.688px]" data-name="Table Cell">
      <Text8 />
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-0 top-[83.17px] w-[211.913px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['JetBrains_Mono:Bold',sans-serif] font-bold leading-[16px] left-[16px] text-[#0f2340] text-[12px] top-[15.59px] tracking-[0.3px] whitespace-nowrap">JO-2026-00120</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[211.91px] top-[83.17px] w-[193.887px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[13.99px] whitespace-nowrap">08 Aug 2026</p>
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[405.8px] top-[83.17px] w-[148.575px]" data-name="Table Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-[132.77px] text-[#364153] text-[14px] text-right top-[13.19px] whitespace-nowrap">124,800</p>
    </div>
  );
}
...
function TableCell8() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[554.38px] top-[83.17px] w-[182.738px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[13.99px] whitespace-nowrap">2/4 items</p>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="absolute bg-[#f0fdf4] border-[#b9f8cf] border-[0.8px] border-solid content-stretch flex items-start left-[16px] px-[8px] py-[2px] rounded-[4px] top-[12.8px]" data-name="Text">
...
function TableCell9() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[46.788px] left-[737.11px] top-[83.17px] w-[183.688px]" data-name="Table Cell">
      <Text9 />
    </div>
  );
}
...
function Table() {
  return (
    <div className="h-[130.363px] overflow-clip relative shrink-0 w-full" data-name="Table">
      <HeaderCell />
      <HeaderCell1 />
      <HeaderCell2 />
      <HeaderCell3 />
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col h-[191.963px] items-start pt-[24px] relative shrink-0 w-[922.4px]" data-name="Container">
      <SectionHeader />
      <CardMargin />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g clipPath="url(#clip0_0_4)" id="Icon">
          <path d={svgPaths.p39ee6532} id="Vector" stroke="#E17100" strokeWidth="1.33333" />
          <path d="M8 4V8L10.6667 9.33333" id="Vector_2" stroke="#E17100" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 3">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] tracking-[0.7px] uppercase whitespace-nowrap">Deferred Work</p>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="bg-[#fffbeb] border-[#fee685] border-[0.8px] border-solid content-stretch flex items-center px-[8px] py-[2px] relative rounded-[26843500px] shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#bb4d00] text-[12px] whitespace-nowrap">4 items</p>
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#99a1af] text-[12px] whitespace-nowrap">Work recommended in previous visits that has not been completed yet.</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-0 top-0 w-[295.75px]" data-name="Header Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[16px] not-italic text-[#6a7282] text-[12px] top-[17.99px] tracking-[0.6px] uppercase whitespace-nowrap">Work Item</p>
    </div>
  );
}
...
function HeaderCell6() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-[295.75px] top-0 w-[97.025px]" data-name="Header Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[16px] not-italic text-[#6a7282] text-[12px] top-[17.99px] tracking-[0.6px] uppercase whitespace-nowrap">Date</p>
    </div>
  );
}
...
function HeaderCell7() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-[392.78px] top-0 w-[107.3px]" data-name="Header Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[16px] not-italic text-[#6a7282] text-[12px] top-[17.99px] tracking-[0.6px] uppercase whitespace-nowrap">Job Order</p>
    </div>
  );
}
...
function HeaderCell8() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-[500.08px] top-0 w-[90.8px]" data-name="Header Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[75.09px] not-italic text-[#6a7282] text-[12px] text-right top-[17.99px] tracking-[0.6px] uppercase whitespace-nowrap">KM</p>
    </div>
  );
}
...
function HeaderCell9() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-[590.88px] top-0 w-[147.363px]" data-name="Header Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[16px] not-italic text-[#6a7282] text-[12px] top-[10px] tracking-[0.6px] uppercase w-[116px]">Recommended By</p>
    </div>
  );
}
...
function HeaderCell10() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-[738.24px] top-0 w-[100.263px]" data-name="Header Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[16px] not-italic text-[#6a7282] text-[12px] top-[17.99px] tracking-[0.6px] uppercase whitespace-nowrap">Status</p>
    </div>
  );
}
...
function HeaderCell11() {
  return (
    <div className="absolute bg-[#f9fafb] border-[#f3f4f6] border-b-[0.8px] border-solid h-[52.375px] left-[838.5px] top-0 w-[82.3px]" data-name="Header Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-[16px] not-italic text-[#6a7282] text-[12px] top-[17.99px] tracking-[0.6px] uppercase whitespace-nowrap">Action</p>
    </div>
  );
}
...
function TableCell10() {
  return (
    <div className="[word-break:break-word] absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-0 not-italic top-[52.38px] w-[295.75px] whitespace-nowrap" data-name="Table Cell">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[16px] text-[#101828] text-[14px] top-[13.4px]">Brake Pads (Front)</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[16px] text-[#99a1af] text-[12px] top-[35.4px]">Heavy wear observed</p>
    </div>
  );
}
...
function TableCell11() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[295.75px] top-[52.38px] w-[97.025px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[13px] w-[66px]">12 Aug 2026</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute h-[40px] left-[16px] top-[12.4px] w-[75.3px]" data-name="Button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['JetBrains_Mono:Bold',sans-serif] font-bold leading-[16px] left-[38px] text-[#0f2340] text-[12px] text-center top-[2.2px] tracking-[0.3px] w-[76px]">JO-2026-00125</p>
    </div>
  );
}
...
function TableCell12() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[392.78px] top-[52.38px] w-[107.3px]" data-name="Table Cell">
      <Button3 />
    </div>
  );
}
...
function TableCell13() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[500.08px] top-[52.38px] w-[90.8px]" data-name="Table Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-[75px] text-[#364153] text-[14px] text-right top-[22.2px] whitespace-nowrap">125,430</p>
    </div>
  );
}
...
function TableCell14() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[590.88px] top-[52.38px] w-[147.363px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[23px] whitespace-nowrap">Karim Samir</p>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="absolute bg-[#fffbeb] border-[#fee685] border-[0.8px] border-solid content-stretch flex items-start left-[16px] px-[8px] py-[2px] rounded-[4px] top-[21.8px]" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#bb4d00] text-[12px] whitespace-nowrap">Deferred</p>
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[738.24px] top-[52.38px] w-[100.263px]" data-name="Table Cell">
      <Text11 />
    </div>
  );
}
...
function Button4() {
  return (
    <div className="absolute h-[15.988px] left-[16px] top-[25.6px] w-[41.888px]" data-name="Button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[21.5px] not-italic text-[#254e87] text-[12px] text-center top-0 whitespace-nowrap">View →</p>
    </div>
  );
}
...
function TableCell16() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[838.5px] top-[52.38px] w-[82.3px]" data-name="Table Cell">
      <Button4 />
    </div>
  );
}
...
function TableCell17() {
  return (
    <div className="[word-break:break-word] absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-0 not-italic top-[117.17px] w-[295.75px] whitespace-nowrap" data-name="Table Cell">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[16px] text-[#101828] text-[14px] top-[13.4px]">Wheel Alignment</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[16px] text-[#99a1af] text-[12px] top-[35.4px]">Recommended</p>
    </div>
  );
}
...
function TableCell18() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[295.75px] top-[117.17px] w-[97.025px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[13px] w-[66px]">12 Aug 2026</p>
    </div>
  );
}
...
function TableCell19() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[392.78px] top-[117.17px] w-[107.3px]" data-name="Table Cell">
      <Button5 />
    </div>
  );
}
...
function TableCell20() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[500.08px] top-[117.17px] w-[90.8px]" data-name="Table Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-[75px] text-[#364153] text-[14px] text-right top-[22.2px] whitespace-nowrap">125,430</p>
    </div>
  );
}
...
function TableCell21() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[590.88px] top-[117.17px] w-[147.363px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[23px] whitespace-nowrap">Karim Samir</p>
    </div>
  );
}
...
function TableCell22() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[738.24px] top-[117.17px] w-[100.263px]" data-name="Table Cell">
      <Text12 />
    </div>
  );
}
...
function TableCell23() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[64.8px] left-[838.5px] top-[117.17px] w-[82.3px]" data-name="Table Cell">
      <Button6 />
    </div>
  );
}
...
function TableCell24() {
  return (
    <div className="[word-break:break-word] absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-0 not-italic top-[181.98px] w-[295.75px]" data-name="Table Cell">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[16px] text-[#101828] text-[14px] top-[12.4px] whitespace-nowrap">Brake Pad Replacement</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[16px] text-[#99a1af] text-[12px] top-[34.4px] w-[264px]">Heavy wear on front and rear pads — customer declined due to cost</p>
    </div>
  );
}
...
function TableCell25() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[295.75px] top-[181.98px] w-[97.025px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[19.99px] w-[66px]">08 Aug 2026</p>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="absolute h-[40px] left-[16px] top-[19.39px] w-[75.3px]" data-name="Button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['JetBrains_Mono:Bold',sans-serif] font-bold leading-[16px] left-[38px] text-[#0f2340] text-[12px] text-center top-[2.2px] tracking-[0.3px] w-[76px]">JO-2026-00120</p>
    </div>
  );
}
...
function TableCell26() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[392.78px] top-[181.98px] w-[107.3px]" data-name="Table Cell">
      <Button7 />
    </div>
  );
}
...
function TableCell27() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[500.08px] top-[181.98px] w-[90.8px]" data-name="Table Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-[75px] text-[#364153] text-[14px] text-right top-[29.19px] whitespace-nowrap">124,800</p>
    </div>
  );
}
...
function TableCell28() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[590.88px] top-[181.98px] w-[147.363px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[29.99px] whitespace-nowrap">Karim Samir</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="absolute bg-[#fffbeb] border-[#fee685] border-[0.8px] border-solid content-stretch flex items-start left-[16px] px-[8px] py-[2px] rounded-[4px] top-[28.79px]" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#bb4d00] text-[12px] whitespace-nowrap">Deferred</p>
    </div>
  );
}
...
function TableCell29() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[738.24px] top-[181.98px] w-[100.263px]" data-name="Table Cell">
      <Text13 />
    </div>
  );
}
...
function Button8() {
  return (
    <div className="absolute h-[15.988px] left-[16px] top-[32.59px] w-[41.888px]" data-name="Button">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[21.5px] not-italic text-[#254e87] text-[12px] text-center top-0 whitespace-nowrap">View →</p>
    </div>
  );
}
...
function TableCell30() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[838.5px] top-[181.98px] w-[82.3px]" data-name="Table Cell">
      <Button8 />
    </div>
  );
}
...
function TableCell31() {
  return (
    <div className="[word-break:break-word] absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-0 not-italic top-[260.75px] w-[295.75px]" data-name="Table Cell">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[16px] text-[#101828] text-[14px] top-[12.4px] whitespace-nowrap">AC Compressor Inspection</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[16px] text-[#99a1af] text-[12px] top-[34.4px] w-[264px]">Noise from AC compressor — requires belt replacement</p>
    </div>
  );
}
...
function TableCell32() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[295.75px] top-[260.75px] w-[97.025px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[19.99px] w-[66px]">08 Aug 2026</p>
    </div>
  );
}
...
function TableCell33() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[392.78px] top-[260.75px] w-[107.3px]" data-name="Table Cell">
      <Button9 />
    </div>
  );
}
...
function TableCell34() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[500.08px] top-[260.75px] w-[90.8px]" data-name="Table Cell">
      <p className="-translate-x-full [word-break:break-word] absolute font-['JetBrains_Mono:Regular',sans-serif] font-normal leading-[20px] left-[75px] text-[#364153] text-[14px] text-right top-[29.19px] whitespace-nowrap">124,800</p>
    </div>
  );
}
...
function TableCell35() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[590.88px] top-[260.75px] w-[147.363px]" data-name="Table Cell">
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#364153] text-[14px] top-[29.99px] whitespace-nowrap">Karim Samir</p>
    </div>
  );
}
...
function TableCell36() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[738.24px] top-[260.75px] w-[100.263px]" data-name="Table Cell">
      <Text14 />
    </div>
  );
}
...
function TableCell37() {
  return (
    <div className="absolute border-[#f9fafb] border-b-[0.8px] border-solid h-[78.775px] left-[838.5px] top-[260.75px] w-[82.3px]" data-name="Table Cell">
      <Button10 />
    </div>
  );
}
...
function Table1() {
  return (
    <div className="h-[339.925px] overflow-clip relative shrink-0 w-full" data-name="Table">
      <HeaderCell5 />
      <HeaderCell6 />
      <HeaderCell7 />
      <HeaderCell8 />
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[24px] relative shrink-0 w-[922.4px]" data-name="Container">
      <Container17 />
      <CardMargin1 />
    </div>
  );
...
function Container() {
  return (
    <div className="bg-[#f3f4f6] content-stretch flex flex-col items-start max-w-[1280px] min-h-[688px] pb-[24px] pl-[248px] pr-[24px] pt-[80px] relative shrink-0 w-[1194.4px]" data-name="Container">
      <VehicleDetail />
    </div>
  );
}
...
function Body() {
  return (
    <div className="content-stretch flex flex-col h-[1094px] items-start relative shrink-0 w-[1194px]" data-name="Body">
      <Container />
    </div>
  );
}
...
function Sidebar() {
  return (
    <div className="absolute bg-[#060f1e] content-stretch flex flex-col h-[1094px] items-start left-0 top-0 w-[224px]" data-name="Sidebar">
      <Container19 />
      <Navigation />
      <Container22 />
    </div>
