...
function Button26() {
  return (
    <div className="bg-[#0f2340] content-stretch flex flex-[531.925_0_0] h-full items-center justify-center min-w-px opacity-50 px-[16px] py-[8px] relative rounded-[4px]" data-name="Button">
...
function Container20() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[496px] items-start left-[261.2px] max-h-[619.2000122070312px] max-w-[672px] overflow-clip rounded-[12px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-[96px] w-[672px]" data-name="Container">
      <Container21 />
