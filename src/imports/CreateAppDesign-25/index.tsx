...
function WarehouseOpenJobOrders() {
  return (
    <div className="content-stretch flex flex-col h-[566px] items-start max-w-[896px] relative shrink-0 w-[896px]" data-name="WarehouseOpenJobOrders">
      <Container />
      <CardMargin />
      <CardMargin1 />
      <Container4 />
...
function App1() {
  return (
    <div className="content-stretch flex flex-col h-[590px] items-center max-w-[1280px] p-[24px] relative shrink-0 w-[970px]" data-name="App">
